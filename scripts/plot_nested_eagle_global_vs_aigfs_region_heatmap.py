#!/usr/bin/env python3
"""
Nested-EAGLE-Global (AI) vs AIGFS regional RMSE improvement heatmap using global 0.25 degree data.
...
Metric:
  RMSE improvement (%) = 100 * (AIGFS_RMSE - NestedEAGLE_RMSE) / AIGFS_RMSE
...
Output:
  /scratch3/NAGAPE/epic/role-epic/EAGLE/eagle_models_vv/scorecard/plots_nested_eagle_vs_gfs_regions/nested_eagle_global_vs_aigfs_regions_rmse_improvement_D1_D10.png
"""
...
GFS_DIR = BASE / "aigfs_2025"

OUTDIR.mkdir(parents=True, exist_ok=True)

OUTPNG = OUTDIR / "nested_eagle_global_vs_aigfs_regions_rmse_improvement_D1_D10.png"
...
ROW_GROUPS = [
    ...
    },
    {
        "name": "surface",
        "rows": [
            {"var": "surface_pressure", "label": "surface_pressure", "levels": None},
            ...
            {"var": "2m_specific_humidity", "label": "2m_specific_humidity", "levels": None},
...
def plot_heatmap(region_mats, rows, group_breaks):
    ...
    fig.suptitle(
        "Nested-EAGLE-Global (AI) vs AIGFS | Global 0.25 degree data",
        fontsize=19,
        fontweight="bold",
        y=0.975,
    )
    ...
    fig.text(
        0.5,
        0.055,
        "RMSE improvement (%) = 100 x (AIGFS RMSE - Nested-EAGLE-Global (AI) RMSE) / AIGFS RMSE. Positive/blue values indicate lower RMSE for Nested-EAGLE-Global (AI). Cell values are RMSE improvement percentages.",
        ha="center",
        va="center",
        fontsize=10,
        color="#333333",
