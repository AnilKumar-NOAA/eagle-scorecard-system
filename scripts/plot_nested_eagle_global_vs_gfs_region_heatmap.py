#!/usr/bin/env python3
"""
Nested-EAGLE-Global (AI) vs GFS regional RMSE improvement heatmap using global 0.25 degree data.
...
Metric:
  RMSE improvement (%) = 100 * (GFS_RMSE - NestedEAGLE_RMSE) / GFS_RMSE
...
Output:
  /scratch3/NAGAPE/epic/role-epic/EAGLE/eagle_models_vv/scorecard/plots_nested_eagle_vs_gfs_regions/nested_eagle_global_vs_gfs_regions_rmse_improvement_D1_D10.png
"""
...
GFS_DIR = BASE / "gfs_2025"

OUTDIR.mkdir(parents=True, exist_ok=True)

OUTPNG = OUTDIR / "nested_eagle_global_vs_gfs_regions_rmse_improvement_D1_D10.png"
...
def plot_heatmap(region_mats, rows, group_breaks):
    ...
    fig.text(
        0.5,
        0.055,
        "RMSE improvement (%) = 100 x (GFS RMSE - Nested-EAGLE-Global (AI) RMSE) / GFS RMSE. Positive/blue values indicate lower RMSE for Nested-EAGLE-Global (AI). Cell values are RMSE improvement percentages.",
        ha="center",
        va="center",
        fontsize=10,
        color="#333333",
