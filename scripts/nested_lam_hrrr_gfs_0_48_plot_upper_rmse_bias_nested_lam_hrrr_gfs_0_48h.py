...
# Run:
#   python plot_upper_rmse_bias_nested_lam_hrrr_gfs_0_48h.py rmse
#   python plot_upper_rmse_bias_nested_lam_hrrr_gfs_0_48h.py bias
...
MODEL_ORDER = ["Nested-EAGLE LAM", "HRRR", "GFS"]
...
def main():
    ...
    fig.text(
        0.5,
        0.955,
        "Nested-EAGLE LAM vs HRRR vs GFS | CONUS | 0-48 h lead time",
        ha="center",
        va="center",
        fontsize=12,
    )
    ...
    outpng = OUTDIR / f"{METRIC}_upper_conus_nested_lam_hrrr_gfs_0_48h_250_500_850.png"
